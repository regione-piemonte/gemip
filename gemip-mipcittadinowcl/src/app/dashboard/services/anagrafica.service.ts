...
export class AnagraficaService {
  ...
  getAnagraficaSpid(): Observable<AnagraficaCittadino> {
    return this.http.get<AnagraficaCittadino>(this.configUrl.anagraficaSpidUrl);
  }
  ...
  get anagraficaCittadino() {
    return JSON.parse(sessionStorage.getItem("anagraficaCittadino")!)
  }

  set anagraficaCittadino(anagraficaCittadino: AnagraficaCittadino | undefined) {
    sessionStorage.setItem("anagraficaCittadino", JSON.stringify(anagraficaCittadino))
  }
}
