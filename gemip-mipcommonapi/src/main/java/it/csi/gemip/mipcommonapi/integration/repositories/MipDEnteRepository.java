...
@RequestScoped
public class MipDEnteRepository implements PanacheRepository<MipDEnte> {

    public List<MipDEnte> getEnti(String descrizione) {
        StringBuilder query = new StringBuilder("");
        // TODO
        return find(query.toString(), descrizione).list();
    }
