...
public interface ProvinceApi  {
     ...
     * responses: 
       <ul>
         <li>    
           ...
           schema implementation = array of { @see Provincia }</p>
         </li>
         <li>    
     ...
     * responses: 
       <ul>
         <li>    
           ...
           schema implementation = { @see Provincia }</p>
         </li>
         <li>    
           <p>responseCode = 400, description = usata quando i campi non sono validati correttamente<br>
           schema implementation = { @see Errore }</p>
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getProvincePerRegione(@NotNull


@jakarta.validation.Valid  @QueryParam("regione") String regione,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
