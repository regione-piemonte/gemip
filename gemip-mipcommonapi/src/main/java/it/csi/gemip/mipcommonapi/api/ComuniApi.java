...
public interface ComuniApi  {
     ...
     * responses: 
       <ul>
         <li>    
           <p>responseCode = 200, description = elenco dei comuni<br>
           schema implementation = array of { @see Comune }</p>
         </li>
         <li>    
    ...
    */
    ...
    Response getComuni(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );

    /**
     * summary = elenco comuni della provincia
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getComuniPerProvincia(@NotNull


@jakarta.validation.Valid  @QueryParam("provincia") String provincia,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
