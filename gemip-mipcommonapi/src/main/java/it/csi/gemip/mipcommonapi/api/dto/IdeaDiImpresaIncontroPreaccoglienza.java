...
public class IdeaDiImpresaIncontroPreaccoglienza   {
  private List<IdeaDiImpresaIncontroPreaccoglienzaIdeaDiImpresa> ideaDiImpresa = new ArrayList<IdeaDiImpresaIncontroPreaccoglienzaIdeaDiImpresa>();
  private Integer risultatiTotali = null;
  ...
  public List<IdeaDiImpresaIncontroPreaccoglienzaIdeaDiImpresa> getIdeaDiImpresa() {
    return ideaDiImpresa;
  }
  public void setIdeaDiImpresa(List<IdeaDiImpresaIncontroPreaccoglienzaIdeaDiImpresa> ideaDiImpresa) {
  ...
  @jakarta.validation.Valid
  public Integer getRisultatiTotali() {
    return risultatiTotali;
  }
  public void setRisultatiTotali(Integer risultatiTotali) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(ideaDiImpresa, ideaDiImpresaIncontroPreaccoglienza.ideaDiImpresa) &&
        Objects.equals(risultatiTotali, ideaDiImpresaIncontroPreaccoglienza.risultatiTotali);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ideaDiImpresa, risultatiTotali);
  }
