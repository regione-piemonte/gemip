...
public class MipDSoggettoAttuatore extends PanacheEntityBase {
    ...
    @NotNull
    @Column(name = "d_disabilitazione", nullable = false)
    ...
    public Date getDataDisabilitazione() { return dataDisabilitazione; }

    public void setDataDisabilitazione(Date dataDisabilitazione) { this.dataDisabilitazione = dataDisabilitazione; }
    ...
    public String toString() {
        return "MipDSoggettoAttuatore{" +
                ...
                ", codiceAreaTerritoriale=" + codiceAreaTerritoriale +
                '}';
    }
}