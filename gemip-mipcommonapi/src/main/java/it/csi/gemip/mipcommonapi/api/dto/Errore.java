...
public class Errore   {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(title, errore.title) &&
        Objects.equals(status, errore.status) &&
        Objects.equals(code, errore.code) &&
        Objects.equals(messaggioCittadino, errore.messaggioCittadino) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, status, code, messaggioCittadino, errorMessage, fields);
  }
