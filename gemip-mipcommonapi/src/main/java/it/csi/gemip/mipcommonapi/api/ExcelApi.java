...
public interface ExcelApi  {
    ...
    */
    ...
    Response exportExcelAnagraficaCittadino(@NotNull


@jakarta.validation.Valid  @QueryParam("idIncontroPreaccoglienza") Long idIncontroPreaccoglienza,@NotNull


@jakarta.validation.Valid  @QueryParam("codOperatore") String codOperatore,


@jakarta.validation.Valid  @QueryParam("idSoggettoAttuatore") String idSoggettoAttuatore,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
...
@jakarta.validation.Valid  @QueryParam("idIncontriPreaccoglienza") String idIncontriPreaccoglienza,
