...
import it.csi.gemip.mipbackofficebff.bff.TutorApi;
...
public class TutorApiImpl extends ParentApiImpl implements TutorApi {
    ...
    @Override
    public Response resetTutor(@NotNull Long idImpresa, SecurityContext securityContext, HttpHeaders httpHeaders,
            HttpServletRequest httpRequest) {
