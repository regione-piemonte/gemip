...
import it.csi.gemip.mipbackofficebff.bff.dto.SoggettoAttuatoreOperatore;
...
public interface SoggettiAttuatoreApi  {
    ...
    */
    ...
    Response cambiaStatoOperatoriSoggettoAttuatore( @NotNull @QueryParam("idSoggettoAttuatore") Long idSoggettoAttuatore, @NotNull @QueryParam("idOperatore") Long idOperatore, @NotNull @QueryParam("idOperatoreDisabilitazione") Long idOperatoreDisabilitazione,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getOperatoriByIdSoggettoAttuatore( @NotNull @QueryParam("idSoggettoAttuatore") Long idSoggettoAttuatore,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getSoggettoAttuatoreByIdOperatori( @NotNull @QueryParam("idOperatore") Long idOperatore,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response updateSoggettoAttuatore( SoggettoAttuatore body,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
