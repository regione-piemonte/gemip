...
import it.csi.gemip.mipbackofficebff.bff.dto.Documento;
import it.csi.gemip.mipbackofficebff.bff.dto.Errore;
import java.io.File;
import it.csi.gemip.mipbackofficebff.bff.dto.TipoDocumento;
...
public interface DocumentiApi  {
    ...
    */
    ...
    Response deleteDocumento( @NotNull @QueryParam("idDocumento") Long idDocumento,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    Response getDocumentiByParameters( @QueryParam("tipoDocumento") String tipoDocumento, @QueryParam("titolo") String titolo, @QueryParam("idIdeaDiImpresa") Long idIdeaDiImpresa,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    Response getDocumentoById( @NotNull @QueryParam("idDocumento") Long idDocumento,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
