...
import java.io.File;
import it.csi.gemip.mipbackofficebff.bff.dto.IdeaDiImpresaRicercaExtendedConTotale;
import it.csi.gemip.mipbackofficebff.bff.dto.ReportQuestionario;
...
public interface ReportisticaApi  {
    ...
    */
    ...
    Response exportExcelIdeeImpresa( @QueryParam("nomeOperatore") String nomeOperatore, @QueryParam("dataDa") Date dataDa, @QueryParam("dataA") Date dataA, @QueryParam("idSoggettoAttuatore") Long idSoggettoAttuatore, @QueryParam("idCodAreaTerritoriale") String idCodAreaTerritoriale, @QueryParam("idStatoIdea") Long idStatoIdea, @QueryParam("tipoReport") String tipoReport,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/octet-stream", "application/json" })
    Response exportExcelQuestionari( @QueryParam("idFase") Long idFase, @QueryParam("dataDa") Date dataDa, @QueryParam("dataA") Date dataA, @QueryParam("idSoggettoAttuatore") Long idSoggettoAttuatore, @QueryParam("idCodAreaTerritoriale") String idCodAreaTerritoriale, @QueryParam("nomeOperatore") String nomeOperatore,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/octet-stream", "application/json" })
    Response getDomandeRisposte( @QueryParam("idFase") Long idFase, @QueryParam("dataDa") Date dataDa, @QueryParam("dataA") Date dataA, @QueryParam("idSoggettoAttuatore") Long idSoggettoAttuatore, @QueryParam("idCodAreaTerritoriale") String idCodAreaTerritoriale, @QueryParam("pageIndex") Integer pageIndex, @QueryParam("pageSize") Integer pageSize,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/octet-stream", "application/json" })
    Response getIdeeImpresa( @QueryParam("dataDa") Date dataDa, @QueryParam("dataA") Date dataA, @QueryParam("idSoggettoAttuatore") Long idSoggettoAttuatore, @QueryParam("idCodAreaTerritoriale") String idCodAreaTerritoriale, @QueryParam("idStatoIdea") Long idStatoIdea, @QueryParam("tipoReport") String tipoReport, @QueryParam("pageIndex") Integer pageIndex, @QueryParam("pageSize") Integer pageSize,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
