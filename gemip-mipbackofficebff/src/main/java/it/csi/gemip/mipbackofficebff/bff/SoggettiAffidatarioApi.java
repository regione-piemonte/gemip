...
public interface SoggettiAffidatarioApi  {
    ...
    */
    ...
    Response getOperatoreSoggettoAffidatario( @QueryParam("idSoggettoAffidatario") Integer idSoggettoAffidatario,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response updateSoggettoAffidatario( SoggettoAffidatario body,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
