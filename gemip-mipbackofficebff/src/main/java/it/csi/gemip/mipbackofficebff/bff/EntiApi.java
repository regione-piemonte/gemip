...
public interface EntiApi  {
    ...
    */
    ...
    Response getEnti( @QueryParam("tipoEnte") String tipoEnte,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getOperatoreEnte( @NotNull @QueryParam("idEnte") Long idEnte,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response updateEnte( Ente body,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
