...
public interface PdfApi  {
     ...
     * description = restituisce il file pdf per le presenze
     * @return Response
     * responses: 
       <ul>
         <li>    
           <p>responseCode = 200, description = pdf<br>
    ...
    */
    @GET
    @Path("/esporta-pdf-presenze")
    
    @Produces({ "application/octet-stream", "application/json" })
    Response exportPdfPresenze( @NotNull @QueryParam("idIncontroPreaccoglienza") Long idIncontroPreaccoglienza,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
