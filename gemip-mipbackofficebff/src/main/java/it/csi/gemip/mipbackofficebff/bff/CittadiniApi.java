...
import it.csi.gemip.mipbackofficebff.bff.dto.AnagraficaCittadinoRicerca;
...
public interface CittadiniApi  {
    ...
    */
    ...
    Response getCittadinoPerIdeaImpresa( @NotNull @QueryParam("idIdeaDiImpresa") Long idIdeaDiImpresa,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getCittadinoPerParametri( @QueryParam("nome") String nome, @QueryParam("cognome") String cognome, @QueryParam("email") String email, @QueryParam("codiceFiscale") String codiceFiscale, @QueryParam("codAreaTerritoriale") String codAreaTerritoriale, @QueryParam("dataInseritoDa") String dataInseritoDa, @QueryParam("dataInseritoA") String dataInseritoA, @QueryParam("idOperatore") Long idOperatore, @QueryParam("idSoggettoAttuatore") Long idSoggettoAttuatore, @QueryParam("pageIndex") Integer pageIndex, @QueryParam("pageSize") Integer pageSize, @QueryParam("orderBy") String orderBy, @QueryParam("sortDirection") String sortDirection,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
