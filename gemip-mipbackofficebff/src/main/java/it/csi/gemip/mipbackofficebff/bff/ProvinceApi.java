...
import it.csi.gemip.mipbackofficebff.bff.dto.Provincia;
...
public interface ProvinceApi  {
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getProvincePerRegione( @NotNull @QueryParam("regione") String regione,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
