...
public class MipROperatoreEnte extends PanacheEntityBase {
    @Id
    @Column(name = "id_operatore_ente", nullable = false, precision = 10)
    //seq_mip_r_operatore_ente
    @SequenceGenerator(
            name = "operatoreEnteSequence",
            sequenceName = "seq_mip_r_operatore_ente",allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "operatoreEnteSequence")
