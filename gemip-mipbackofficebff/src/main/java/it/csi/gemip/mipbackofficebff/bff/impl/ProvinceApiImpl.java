...
import it.csi.gemip.mipbackofficebff.bff.ProvinceApi;
...
public class ProvinceApiImpl extends  ParentApiImpl implements ProvinceApi {
  ...
  @Override
  public Response getProvincePerRegione(String regione, SecurityContext securityContext, HttpHeaders httpHeaders, HttpServletRequest httpRequest) {
    return  restUtils.chiamateGet(uriInfo);
  }
}
