...
import it.csi.gemip.mipbackofficebff.bff.dto.Cpi;
import it.csi.gemip.mipbackofficebff.bff.dto.Operatore;
import java.util.Date;
import jakarta.validation.constraints.*;

public class CpiOperatore   {
  private Long id = null;
  private Cpi soggettoAttuatore = null;
  ...
  public Cpi getSoggettoAttuatore() {
    return soggettoAttuatore;
  }
  public void setSoggettoAttuatore(Cpi soggettoAttuatore) {
  ...
  public boolean equals(Object o) {
    ...
    CpiOperatore cpiOperatore = (CpiOperatore) o;
    return Objects.equals(id, cpiOperatore.id) &&
        Objects.equals(soggettoAttuatore, cpiOperatore.soggettoAttuatore) &&
        Objects.equals(operatore, cpiOperatore.operatore) &&
        Objects.equals(codUserInserim, cpiOperatore.codUserInserim) &&
        Objects.equals(dataInserim, cpiOperatore.dataInserim) &&
        Objects.equals(codUserAggiorn, cpiOperatore.codUserAggiorn) &&
        Objects.equals(dataAggiorn, cpiOperatore.dataAggiorn);
  }
