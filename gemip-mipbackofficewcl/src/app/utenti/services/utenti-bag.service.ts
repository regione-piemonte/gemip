...
export class UtentiBagService {
  private _anagraficaCittadino?:AnagraficaCittadino;
  private _idAnagraficaCittadino?:number;
  ...
  get idAnagraficaCittadino(){
    return this._idAnagraficaCittadino
  }
  set idAnagraficaCittadino(id:number | undefined){
    this._idAnagraficaCittadino = id;
  }
