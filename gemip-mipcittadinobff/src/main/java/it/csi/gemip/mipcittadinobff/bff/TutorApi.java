...
import it.csi.gemip.mipcittadinobff.bff.dto.Tutor;
...
public interface TutorApi  {
    ...
    */
    ...
    Response getTutorAbilitatiPerAreaTerritoriale( @QueryParam("codAreaTerritoriale") String codAreaTerritoriale,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getTutorPerAreaTerritoriale( @QueryParam("codAreaTerritoriale") String codAreaTerritoriale,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response getTutorPerId( @NotNull @QueryParam("idTutor") Long idTutor,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
    ...
    */
    ...
    @Produces({ "application/json" })
    Response sceltaTutor( @NotNull @QueryParam("idTutor") Long idTutor, @NotNull @QueryParam("idImpresa") Long idImpresa,@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders , @Context HttpServletRequest httpRequest );
